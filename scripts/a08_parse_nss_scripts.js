...
import {MatchSrtToNss} from "../backend/MatchTextractorToNss.js";
import {REVENGE_ROUTE_REC3_DIR} from "../backend/assets_index.js";
...
const main = async () => {
    const matched = await MatchSrtToNss({
        dirPath: REVENGE_ROUTE_REC3_DIR,
    });
