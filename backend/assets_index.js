...
export const RECORDING_LOCATIONS = [
    ...
    [__dirname + '/../public/assets/mc_revenge_route/rec5', 'game_recording_during_h'],
    [__dirname + '/../public/assets/mc_revenge_route/rec5', 'game_recording_after_h'],
    [__dirname + '/../public/assets/mc_revenge_route/rec5'],
    [__dirname + '/../public/assets/mc_revenge_route/rec6_sayo_no_uta'],
    ...
    [__dirname + '/../public/assets/md_devil_route/rec8', 'game_recording_between_h'],
