...
export const RECORDING_LOCATIONS = [
  ...
  [__dirname + '/../assets/recordings/ayane_route/rec2', 'game_recording_during_h2'],
  [__dirname + '/../assets/recordings/ayane_route/rec2', 'game_recording_after_h2'],
  [__dirname + '/../assets/recordings/ayane_route/rec3'],
