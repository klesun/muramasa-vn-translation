...
function DebugSetText()
{
	...
	if($GRSelect){
		SetFont("ＭＳ ゴシック", 20, FF9933, 000000, 500, RIGHTDOWN);
	}else{
		SetFont("ＭＳ ゴシック", 20, FFFFFF, 000000, 500, RIGHTDOWN);
	}
	CreateText($DebugTitleNat, 100, $DebugX1, $DebugY1, Auto, Auto, $DebugTitle);

	if($DebugMem!=false){
		SetFont("ＭＳ ゴシック", 20, F0FF00, 000000, 500, RIGHTDOWN);
	}else{
		SetFont("ＭＳ ゴシック", 20, 888888, 000000, 500, RIGHTDOWN);
	}
