...
function To_Manual(){
	...
	SetFont("ＭＳ ゴシック", 20, FFFFFF, 000000, MEDIUM, RIGHTDOWN);
	CreateText("テキスト１", 18001, 50, 50, 700, 500, "【ゲーム説明】");
	Fade("テキスト１", 0, 0, null, true);
	CreateText("テキスト２", 18001, 70, 80, 700, 500, "辰気の調和とは、辰気の強さの均衡を意味する。");
	Fade("テキスト２", 0, 0, null, true);

	CreateText("テキスト３", 18001, 70, 110, 700, 500, "従って、この立方体空間に辰気の安定をもたらすのならば");
	Fade("テキスト３", 0, 0, null, true);
	CreateText("テキスト４", 18001, 70, 140, 700, 500, "あらゆる直線と、あらゆる対角線が同等の強さを持つよう");
	Fade("テキスト４", 0, 0, null, true);
	CreateText("テキスト５", 18001, 70, 170, 700, 500, "に辰気１２５種を配分しなくてはならない。");
	Fade("テキスト５", 0, 0, null, true);
	SetFont("ＭＳ ゴシック", 20, #FFFF00, 000000, MEDIUM, RIGHTDOWN);
	CreateText("テキスト６", 18001, 70, 200, 700, 500, "数字にカーソルを合わせてクリックした後、マスに");
	Fade("テキスト６", 0, 0, null, true);
	CreateText("テキスト７", 18001, 70, 230, 700, 500, "カーソルを合わせてクリックすると、選択した数字が");
	Fade("テキスト７", 0, 0, null, true);
	CreateText("テキスト８", 18001, 70, 260, 700, 500, "選択したマスに納まります。");
	Fade("テキスト８", 0, 0, null, true);
	CreateText("テキスト９", 18001, 70, 290, 700, 500, "全ての数字をマスに納め終わりましたら『解答する』");
	Fade("テキスト９", 0, 0, null, true);
	CreateText("テキスト１０", 18001, 70, 320, 700, 500, "をクリックしてください。");
