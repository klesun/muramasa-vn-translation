...
..		//▼定義「バージョン情報」
		#SYSTEM_version="1.00";
		#SCRIPT_VERSION="1.30";
		SetFont("ＭＳ 明朝", 11, #bb7420, #bb7420, 500, NONE);
		$str="<SPAN value=11>◆ＧＡＭＥシステムバージョン情報：</SPAN><PRE>"+#SYSTEM_version+"</PRE>";
		$str2="<SPAN value=11>◆ＧＡＭＥスクリプトバージョン情報：</SPAN><PRE>"+#SCRIPT_VERSION+"</PRE>";
...
..				//★ユーザー登録
				case Config1a_You{
					...
					System("OPEN:http://www.nitroplus.co.jp/userentry/1701/", "", "");
				}
..				//★CRコード
				case Config1a_QRc{
					#SYSTEM_window_full=false;
